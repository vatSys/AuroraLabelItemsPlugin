...

        {
            ...
            switch (itemType)
            {
              ...
              case STRIP_ITEM_CTLSECTOR:
                    ...
                    bool pendingCoordination = flightDataRecord.State == FDR.FDRStates.STATE_PREACTIVE || flightDataRecord.State == FDR.FDRStates.STATE_COORDINATED;
                    ...
                    if (pendingCoordination) 
                    {
                        return new CustomStripItem()
                        {
                            ...
                            Text = flightDataRecord.ControllingSector.Name
                        };
                    }
                    else
                    {
